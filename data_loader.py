...
def fetch_dataloader(types, params):
    ...
    if params.dataset == 'cifar10':
        trainset = torchvision.datasets.CIFAR10(root='/nfs/volume-411-2/weihuapeng/Project/jybfile/datasets/cifar-10-python', train=True,
                                                download=True, transform=train_transformer)
        devset = torchvision.datasets.CIFAR10(root='/nfs/volume-411-2/weihuapeng/Project/jybfile/datasets/cifar-10-python', train=False,
...
def fetch_subset_dataloader(types, params):
    ...
    if params.dataset=='cifar10':
        ...
        # data_dir = './data/tiny-imagenet-200/'
        data_dir = '/nfs/volume-411-2/weihuapeng/Project/jybfile/datasets/tiny-imagenet-200/'
        data_transforms = {
            'train': transforms.Compose([
                transforms.RandomRotation(20),
                transforms.RandomHorizontalFlip(0.5),
