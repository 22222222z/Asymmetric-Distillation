...
from data.augmentations.randomized_quantization import RandomizedQuantizationAugModule
...
def get_transform(transform_type='default', image_size=32, args=None):
    ...
    elif transform_type == 'randomized_quantization':
