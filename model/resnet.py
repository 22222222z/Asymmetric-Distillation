...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=20):
        ...
        # for 32 image size
        if num_classes == 6 or num_classes == 4:
            self.linear = nn.Linear(512*block.expansion, num_classes)
    ...
    def forward(self, x, return_feature=False, feat1=None, feat2=None, lam=None):
        out = F.relu(self.bn1(self.conv1(x)))
        ...
        if return_feature:  
            return feature, out # feature2 #, feature3, feature4
        return out
